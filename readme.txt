...
2026/07/05 v0.8.0
Excelへの出力機能を追加しました。
返信作成時にマーカー（root、reply）を追加するようにしました。
返信、引用、リアクション、リポストの送信時にリレーヒントを追加するようにしました。

2025/04/06 v0.7.1
フォロイーの投稿を非表示にできるようにしました。
Google_GenerativeAIライブラリを更新しました。
GeminiのGoogle検索を有効にしました。

2025/01/22 v0.7.0
非フォロイーの投稿を言語でフィルタリングする設定を追加しました。
Geminiによるタイムラインまとめ画面を追加しました。
※F5キーで表示できます。
API Keyを入力して利用できます。
※API KeyはWindows資格情報に保存されます。
...
2024/12/04 v0.6.1
Webビューを開く際に余計なリレーヒントを含めていたのを修正しました。

2024/12/03 v0.6.0
ログアウトボタンに画像を追加しました。
Nostr秘密鍵によるログインの正式版として公開。
